...
% (b) run app:numerics as specified (discharges sh:ansatz to
% numerically-supported); (c) the identification map (gs:sub:limit),
...
inference of the doomsday argument is \emph{not} recovered: a position
