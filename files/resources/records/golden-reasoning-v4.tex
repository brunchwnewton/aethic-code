...
@misc{Ben24Nexus, author={Benander, Ajax}, title={Nexic Reasoning: Defining a Generalized Calculus Over Anthropic Parameters}, year={2024}, doi={10.31219/osf.io/jvkcp}, note={Also at osf.io/jvkcp}}
...
\bibitem[Ben24]{Ben24Nexus} A.~Benander, \emph{Nexic Reasoning: Defining
...
\section{Continuing from Nexic Reasoning}

\begin{prince}[Past-Alignment Principle]
    The past-alignment principle of Golden Reasoning is the assessment that the Nexus of Optimation is best constructed simply by (1) conditioning the Cosmic Nexus on the Golden Point to create the ``Golden Nexus", and then (2) dropping out all stated-attributes whose referential event proper time exists in one's own future light cone, (or in the more specific case\footnote{That is, because we also now drop the spacelike ones.}, dropping those existing anywhere outside one's past light cone). Put another way, the thesis proposes that should you Aethically condition on the Golden Nexus despite the Golden Point as a spacetime event occurring centuries in the future, render the Aethic block universe to such, and then explicitly mark out the parent Aethus of attributes to this whose occurrence positions exist explicitly in the past light cone subspace of our own exact block universe position here on Earth 2026\footnote{As of the writing of this, anyway.}, then eerily these are exactly the same attributes already filling the past light cone of our own position as conditioning on the very Aetherian Nexus which drove one's own centric unfolding in accordance with the natural historical attributes of Nexic reasoning. Simply speaking, \emph{the past light cone we actually\footnote{Or, more technically rather than \textit{precisely} our actual light cone, which due to random contingency in the centric unfolding is a proper child Aethus of the Aetherian Nexus rather than the entire Aetherian Nexus, it is simply the past light cone of the Aetherian Nexus's own Aethic block universe.} see worth of Aethic attributes is also the same one as the past light cone through our position in the Aethic block universe of the Golden Nexus}.

    Expressed in terms of the Optimal Earth Conjecture of Nexic reasoning, the thesis of the past-alignment principle is that the optimal natural history as granted by Optimation is not simply vaguely observer-conditioned, but rather is highly specifically the act of asking for the optimal Aethus history to the Golden Point, and then surgically reopening all Aethic attributes whose occurrence occurs in the future light cone to a given spacetime event $\alpha$---presumed to be one's own spacetime present, not because this point is special but simply because one may not reliably infer things about the future light cone attributes prior to engaging in Golden Reasoning. Put simply, \emph{the past-alignment principle explicitly does not stake a claim about whether the Aethic attributes in one's future light cone consist with the near-optimal part of the Golden Nexus, but points out the slightly more general argument that the past light cone Aethic attributes we observe are eerily exact as consisting with those of the Golden Nexus under the same spacetime region, (with it being up to a series of further hypothesis, each attesting for a different form of realism, whether the other regions of Optimation's spacetime also consist with the Golden Nexus). So, if you will, said strongly the thesis is that like a spotlight, if you limit by cropping all Aethic attributes of the Golden Nexus to one's own past light cone, you simply re-attain the Nexus of Optimation precisely---and so of course the argument is that this itself, due to the sheer coincidence of it, ought to be the first principles-based derivation of Optimation}.
\end{prince}
The argument in support of the past-alignment principle effectively asks us to (1) make note of the specific subset of stated-attributes in one's own Aethus which well-position uniquely our civilization to trigger the Golden Point within the next few centuries, and then (2) notice how Aethic perturbations over natural and perhaps even human history systematically undermine some or all of these stated-attributes. The list of examples is endless, but we might name the ability of ours to build rocket ships as uniquely positioning our civilization to enable the survival of our biosphere beyond the inevitable death of the sun. Now imagine we look at Aethic perturbations of our natural history for which dinosaurs never go extinct, animal life never evolves, and that the continent of Africa never existed or was very different. Respectively, this would lead to the problem that dinosaurs lacked the intelligence capacity\footnote{That is, since the accordance principle deduces that dinosaurs will not have hit our intelligence.} to build rocket ships, that fungi lacked the animal-capabilities needed to build rocket ships, and that arboreal\footnote{That is, because the specific sequence of climactic events occurring in Africa is what drove our great ape ancestors to become bipedal in the first place.} great apes lacked the human strategic thinking and bipedal-orientation needed to build rocket ships. Furthermore, by applying the substitution property of the Accordance Principle \cite{Nexus} directly, we can establish that for any given important trait of ours in this regard---being rocket ship-construction or what have you---and Aethic perturbations of natural history will systematically have undermined their occurrence probabilities, (that is because of how even our own parent Aethus traits may be used as anchors for the accordance principle, thereby deducing alternative natural histories as probabilistically almost surely failing to account for them). Therefore, the conclusion is that our state of having the specific collection of traits which enables our ideal avenue to the Golden Point itself allows for the inference that the Aethus of our natural history locally optimizes the probability for the Golden Point, therefore meaning that our own natural history is literally the past light cone subdivision of the optimal Aethus for the Golden Nexus. 

We may also propose the fundamental \textit{Golden-conditioning hypothesis}, which states more simply that Nexic natural history never actually fundamentally conditioned on the Nexus of Optimation in the first place, but instead on the Golden Nexus all along. The following is a mediocrity principle-dependent proof-by-contradiction for this stance. 
\begin{prince}[Argument for the Golden-Conditioning Hypothesis]
    One reading of Nexic reasoning is that the Accordance Principle conditions on personal observer existence as opposed to on an event like the Golden Point or its rendition as the Golden Aethus. Based on this reading, we may note that as far as sufficing as an intuitively categorical ``observer" goes, we are perfectly capable of shedding certain probabalistic prerequisites to the Golden Point like rocket ships or the existence of industrial-driving coal on Earth and by Aethic perturbation replacing them with their logical complements all while not upsetting the categorization of ourselves as observers. For instance, if Earth simply lacked sufficient natural resources for us to initiate the industrial revolution, and still we would be no less observers. Altogether, then, if we select even a handful of such stated-attributes which are necessary for the Golden Point while at once unlikely to exist under the reopening of them in the Aetherian Nexus, and the totality of all such counterfactual Aethae will sum to holding significantly more Aethic weight than the Aetherian Nexus, while all once holding a comparatively minute probability of the Golden Point due to lacking the necessary prerequisite attributes. Therefore, if the Accordance Principle were indeed conditioned on observer existence alone, then it would deduce that this significantly higher Aethic weight counterfactual sum would be far likelier to house us than the Aetherian Nexus, which is a direct contradiction to our in fact holding the Aetherian Nexus as our parent Aethus instead. Therefore, the Accordance Principle cannot be conditioned on observers so long as the definition of observer is robust enough to sustain such Aethic perturbations. 

    What this leaves us with, therefore, is the empirical artifact that is the Past-Alignment Principle itself, for which we assess that so much as simply conditioning on the existence of the Golden Point in our Aethic block universe then reproduces exactly the inferential form of the Accordance Principle that deduces all the stated-attributes of Nexic reasoning. In other words, of all the contingent natural histories we could find ourselves on the resultant end of, from a fungus world to a dinosaurs-survive world to a fully lemur-inhabited world, the particular one that we ought to condition on to reproduce precisely the Nexic-inferential state of events we actually see and operate over is itself the one for which the Golden Point exists somewhere in the block universe. 
\end{prince}

\begin{definition}[Extrapolation Hypotheses]
    The following three concepts are three competing possibilities for how the extrapolation to our future light cone of the Aetherian Nexus might play out. 
    \begin{itemize}
    \item \textbf{Void Extrapolation Hypothesis}
    It is merely a brute, uninfluential coincidence that our past light cone lines up with the past light cone to the Golden Aethus as indexed by our position in spacetime. Even if there is or is not a connection at play there, there is no law or inferential rule in the universe which enforces our future light cone to also align with that of the Golden Nexus as taken as our spacetime position. 

    \item \textbf{Weak Extrapolation Hypothesis}

    There is an explicit probability distribution at play such that the Nexus describing our future light cone is given such that each of its proper child Aethae holds an Aethic weight proportional to a given function of its probability of the Golden Point, such as in the simple case simply that probability outright. In such a case, even if the Golden Point does not occur, we are at least limited to the inferential capacity to, when comparing two possible futures, roughly apply an Accordance Principle-like metric for which the probability of either possibility occurring is proportional to the probability of the Golden Point should it happen. For scenarios where the Golden Point does not occur, they are either incomparable under this methodology, or in the strong case, hold probability zero of validly occurring relative to one's Aethus. 

    \item \textbf{Strong Extrapolation Hypothesis}

    The Golden Aethus is already stated in one's Aethus, and has been essentially since the beginning of one's centric unfolding, whenever that was anyway. In that sense, the stated-attributes of Nexic reasoning, per the Accordance Principle, were conditioning over the Golden Point all along, and we ourselves simply physically exist in the Aethic block universe with a physical moving present progressing at a couple of hundred years prior to the Golden Point, while the Aethic conditioning that it will occur has been already fully worked out so as to provide us with exactly the Nexic natural historical considerations that we may read off the region that is our position's personal past light cone. In such a case, random contingency still remains in which route we will take to the Golden Point (or more properly Aethically speaking, which particular stated-attributes we will come to gather conditioning on their consisting with the Golden Point), but we know that Aethic disjointness outright with the Golden Point is already Aethically forbidden.

    The central metaphysical question then becomes (1) why we are able to indeed possess future light cone Aethic information in the first place, (2) how and why this information is so intimately related to the initiation of centric unfolding to begin with, being perhaps its first and leading piece of Aethic information ever, and (3) what the implications are to the entropic principle of Aethic reasoning and its implications for past being distributed in the past versus future Aethic light cones. One avenue of interest might be to try to derive one of (2) or (3) from the other, even. 
    \end{itemize}
\end{definition}
...
given by the Cox construction of the driftless case. There is \emph{no}
...
Three separate claims must be kept apart, and an earlier draft of this part conflated the first two.
...
with $x<0$; the sign of the credit is a phase the system passes
through and re-enters, not a property it has. Technoanatomy in the
sense of Definition~\ref{gr1:def:anatomy} is the exponent $\rho$, which
governs what capacity \emph{does} when acquired and does not fluctuate
at all. An earlier treatment of this material introduced a polar
decomposition $x_t=\sigma t^{3/2}R_t\cos\Theta_t$ and named the phase
$\Theta$ ``technoanatomy''. That naming has been withdrawn, and the
decomposition with it, for a reason worth recording rather than
quietly repairing: the modulus and phase are Rayleigh and uniform, and
independent, only because the normalised pair $(\hat x,Q)$ is isotropic
Gaussian --- which holds in the driftless, unconditioned case and in no
other. Under a transient driver, under $\rho<0$, or under conditioning
on survival, the pair is not isotropic and the construction's every
distributional claim fails. It described one cell of the classification
of \S\ref{gr1:sub:twocond} while presenting itself as the model's
coordinate system. What survives it is this theorem, which needs no
decomposition, and the measurement of \S\ref{gr:subsub:measured}, which
is a fact about the sign of $x$.
\end{remark}


% ---------------------------------------------------------------------
\subsection{The verdict: certain death, infinite expectation}\label{gr1:sub:verdict}\label{sh:sub:verdict}
...
sharpening of the driftless case. It is more than that: it is the engine of the
proof just given. Where the driftless case needed an unbounded integrand,
...
null recurrence: certain death, infinite mean\\
...
a Lindy law; still $\int^\infty r=\infty$, so death is certain\\
\bottomrule
\end{tabular}
\end{center}
...
boundary --- any positive exponent gives certain death --- but deep
...
would appear to fail, and an earlier version of this footnote made
exactly that error. The correction is recorded because it bears on how
much the entry anticipates: the answer is all of it.
...
\S\ref{gr1:sub:coords}, with which an earlier treatment conflated it.
...
\S\S\ref{gr1:sub:verdict}--\ref{gr1:sub:cond} --- certain death,
...
\cite{Ben24Nexus, Ben26Found, Ben26Optimal}. The two are orthogonal
...
``bad anatomy'' means, and why the identification of the two in an
earlier treatment had to be withdrawn.
...
One correction is recorded here rather than buried. An earlier treatment
compared the conditioned marginals of a polar pair $(R,\Theta)$ and
reported divergences of $1.16$ against $0.94$ nats, concluding that
conditioning acts on the two with comparable force. Those were two
halves of a single Gaussian coordinate, not strength against anatomy,
and the comparison has been withdrawn along with the decomposition
(Remark~\ref{gr1:rem:halfuse}). The comparison above replaces it and is
...
scale cannot see.} An earlier version of this section asserted that no
terminal stage exists at all, on the ground that
$\Lambda_\infty=\infty$ almost surely. That was true of the driftless
model and false in general, and the correction is not a retreat but a
sharpening. By Theorem~\ref{gr1:thm:twocond},
\[
...
proportion --- while still dying with probability one.
...
\cite{Ben24Nexus} argues that the astrobiological Copernican principle
...
\cite{Ben24Nexus, Ben26Found, Ben26Optimal}. \emph{Falsifier:} the
...
$\tfrac14$ exponent is McKean's, the polar decomposition is standard
Gaussian whitening, the background construction is an application of
known results on sums of random exponentials --- the Lindy
...
six costs are costs \emph{of}. What is unconditional is less than an earlier draft claimed, and the
ledger states the reduced list: that conditioning selects, that adverse
...
inference an earlier draft drew and had to withdraw.
\end{remark}
