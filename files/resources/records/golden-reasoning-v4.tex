...
``some other lineage'' is owed. A successor arising is itself an Aethus
with (A) and (B) complemented, so it receives the same displacement by
the same two results; there is no second population of alternatives to
survey, because every alternative is a perturbation of ours.
