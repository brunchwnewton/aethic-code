...
the branch; the Route World companion \cite{RouteWorld} imports this
paper and the survivorship one to state its hypothesis; and the
technoanatomy companion, downstream of all three, imports whatever it
uses directly. No downstream paper is cited here as support for
anything.
