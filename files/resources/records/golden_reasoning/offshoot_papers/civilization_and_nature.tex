...
by none of them; it does not use the theorem companion directly.
...
\emph{The Golden Point is the only route to positive viability.}
Every alternative has viability zero. A biosphere without a
...
and accumulating capability yields $\PP(\Lambda_\infty<\infty)>0$; and
the criterion is positive probability of indefinite persistence, not
...
finite trajectory shown to separate the two laws with probability one,
which the ceiling forbids. Against the successor
