...
threshold the same conditioning prefers the schedule pushed and pushed
optimally; and no event of bounded duration can certify which way it
has gone.
...
fluctuates, and by Theorem~\ref{imp:half} every biosphere, however well constituted, spends exactly half of logarithmic time
...
a product. Let $K_{\mathrm{sch}}(d\mu,dx,d\rho)$ be the \emph{surviving-completion
...
survival-time threshold prefers the schedule pushed and pushed
optimally, which is the mechanism of the ladder; and no event of bounded
