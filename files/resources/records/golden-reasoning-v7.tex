...
The remainder develops the philosophical apparatus this licenses and, as
carefully, what it does not: a grounding for the paper's normative
vocabulary that adds exactly one adoptable premise; a decision rule whose
limit form is a ratio of persistence-harmonic values; and an epistemic
ceiling, proved rather than conceded, that this work turns against its own
conclusions as firmly as against its targets.
\end{abstract}
...
(Remark~\ref{gc:rem:weakposition}). Strong deserves the same, and what it needs is different in kind: Void and Weak needed their commitments
